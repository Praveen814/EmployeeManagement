...
public class AddLeaves extends javax.swing.JFrame {
    ...
    String strEmpid, strFromDate, strToDate;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            sql = "insert into leaves(id, empid, fromdate, todate) values('" + strEmpid + "','" + strEmpid + "','" + strFromDate + "','" + strToDate + "')";
    ...
    public void getData(){
        ...
        strFromDate  = this.jtfFromDate.getText();
        strToDate = this.jtfToDate.getText();
    }
